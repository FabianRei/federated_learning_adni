...
if __name__ == '__main__':
    super_path = r'C:\Users\Fabian\stanford\fed_learning\rsync\fl\experiments\seeds_more_dists'
    ...
    csv_dict = {'dist_10': dist_10, 'one_slice': one_slice, 'three_slice': three_slice}
    ...
    for key, val in csv_dict.items():
        ...
        columns = ['test_acc', 'train_acc', 'train_loss', 'test_label_acc_train', 'test_label_acc_test']
        res, raw_res = get_mean_std(csv_files, columns)
        viz_training_data(out_path, res['mean_test_label_acc_train'], res['mean_test_label_acc_test'], res['epochs'], identifier=case_id)
        write_args2csv(res, case_id, out_path)
        write_raw2csv(raw_res, case_id, out_path)
